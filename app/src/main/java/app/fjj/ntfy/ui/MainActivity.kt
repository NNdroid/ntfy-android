...
import app.fjj.ntfy.BuildConfig
import app.fjj.ntfy.R
import app.fjj.ntfy.app.Application
import app.fjj.ntfy.db.Repository
import app.fjj.ntfy.db.Subscription
import app.fjj.ntfy.firebase.FirebaseMessenger
import app.fjj.ntfy.msg.ApiService
import app.fjj.ntfy.msg.DownloadManager
import app.fjj.ntfy.msg.DownloadType
import app.fjj.ntfy.msg.NotificationDispatcher
import app.fjj.ntfy.service.SubscriberService
import app.fjj.ntfy.service.SubscriberServiceManager
import app.fjj.ntfy.util.*
import app.fjj.ntfy.work.DeleteWorker
import app.fjj.ntfy.work.PollWorker
...
class MainActivity : AppCompatActivity(), ActionMode.Callback, AddFragment.SubscribeListener, NotificationFragment.NotificationSettingsListener {
    private val viewModel by viewModels<SubscriptionsViewModel> {
        SubscriptionsViewModelFactory((application as app.fjj.ntfy.app.Application).repository)
    }
    private val repository by lazy { (application as app.fjj.ntfy.app.Application).repository }
