...
import app.fjj.ntfy.db.ConnectionState
...
import app.fjj.ntfy.ui.Colors
import app.fjj.ntfy.ui.MainActivity
...
class SubscriberService : Service() {
    ...
    private fun onNotificationReceived(subscription: Subscription, notification: app.fjj.ntfy.db.Notification) {
