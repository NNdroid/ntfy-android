...
import app.fjj.ntfy.db.*
import app.fjj.ntfy.msg.NotificationService.Companion.ACTION_BROADCAST
import app.fjj.ntfy.msg.NotificationService.Companion.ACTION_HTTP
...
class UserActionWorker(private val context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    override fun doWork(): Result {
        if (context.applicationContext !is app.fjj.ntfy.app.Application) return Result.failure()
        ...
        val app = context.applicationContext as app.fjj.ntfy.app.Application
